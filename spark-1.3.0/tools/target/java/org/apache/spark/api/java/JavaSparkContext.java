...
public  class JavaSparkContext extends org.apache.spark.api.java.JavaSparkContextVarargsWorkaround implements java.io.Closeable {
   ...
   * specialization.
   */
  static public <T extends java.lang.Object> scala.reflect.ClassTag<T> fakeClassTag () { throw new RuntimeException(); }
   ...
   * <p>
   * Do
   * <code>JavaPairRDD<String, byte[]> rdd = sparkContext.dataStreamFiles("hdfs://a-hdfs-path")</code>,
   * <p>
