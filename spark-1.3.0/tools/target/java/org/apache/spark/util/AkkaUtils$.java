 ...
 */
public  class AkkaUtils$ implements org.apache.spark.Logging {
  /**
  ...
  private  int AKKA_MAX_FRAME_SIZE_IN_MB () { throw new RuntimeException(); }
   ...
   */
  public <T extends java.lang.Object> T askWithReply (Object message, akka.actor.ActorRef actor, scala.concurrent.duration.FiniteDuration timeout) { throw new RuntimeException(); }
  /**
   * Send a message to the given actor and get its result within a default timeout, or
   * throw a SparkException if this fails even after the specified number of retries.
   */
  public <T extends java.lang.Object> T askWithReply (Object message, akka.actor.ActorRef actor, int maxAttempts, int retryInterval, scala.concurrent.duration.FiniteDuration timeout) { throw new RuntimeException(); }
  ...
  public  akka.actor.ActorRef makeExecutorRef (java.lang.String name, org.apache.spark.SparkConf conf, java.lang.String host, int port, akka.actor.ActorSystem actorSystem) { throw new RuntimeException(); }
  public  java.lang.String protocol (akka.actor.ActorSystem actorSystem) { throw new RuntimeException(); }
  public  java.lang.String protocol (boolean ssl) { throw new RuntimeException(); }
  public  java.lang.String address (java.lang.String protocol, java.lang.String systemName, java.lang.String host, Object port, java.lang.String actorName) { throw new RuntimeException(); }
}
