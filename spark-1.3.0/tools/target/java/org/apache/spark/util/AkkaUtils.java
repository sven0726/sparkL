...
public  class AkkaUtils implements org.apache.spark.Logging {
   ...
   */
  static public <T extends java.lang.Object> T askWithReply (Object message, akka.actor.ActorRef actor, scala.concurrent.duration.FiniteDuration timeout) { throw new RuntimeException(); }
  /**
   * Send a message to the given actor and get its result within a default timeout, or
   * throw a SparkException if this fails even after the specified number of retries.
   */
  static public <T extends java.lang.Object> T askWithReply (Object message, akka.actor.ActorRef actor, int maxAttempts, int retryInterval, scala.concurrent.duration.FiniteDuration timeout) { throw new RuntimeException(); }
  ...
  static public  java.lang.String address (java.lang.String protocol, java.lang.String systemName, java.lang.String host, Object port, java.lang.String actorName) { throw new RuntimeException(); }
}
