 ...
 */
public abstract class Task<T extends java.lang.Object> implements scala.Serializable {
  /**
   ...
   */
  public final  T run (long taskAttemptId, int attemptNumber) { throw new RuntimeException(); }
