 ...
 */
public  class TaskSchedulerImpl implements org.apache.spark.scheduler.TaskScheduler, org.apache.spark.Logging {
  /**
  ...
  public  org.apache.spark.scheduler.TaskSetManager createTaskSetManager (org.apache.spark.scheduler.TaskSet taskSet, int maxTaskFailures) { throw new RuntimeException(); }
  ...
  private  boolean resourceOfferSingleTaskSet (org.apache.spark.scheduler.TaskSetManager taskSet, scala.Enumeration.Value maxLocality, scala.collection.Seq<org.apache.spark.scheduler.WorkerOffer> shuffledOffers, int[] availableCpus, scala.collection.Seq<scala.collection.mutable.ArrayBuffer<org.apache.spark.scheduler.TaskDescription>> tasks) { throw new RuntimeException(); }
  /**
