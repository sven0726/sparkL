 ...
 */
public  class TaskDescription implements scala.Serializable {
  ...
  // not preceding
  public   TaskDescription (long taskId, int attemptNumber, java.lang.String executorId, java.lang.String name, int index, java.nio.ByteBuffer _serializedTask) { throw new RuntimeException(); }
