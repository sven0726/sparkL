...
public  class HadoopRDD<K extends java.lang.Object, V extends java.lang.Object> extends org.apache.spark.rdd.RDD<scala.Tuple2<K, V>> implements org.apache.spark.Logging {
   ...
   */
  static public  class HadoopMapPartitionsWithSplitRDD<U extends java.lang.Object, T extends java.lang.Object> extends org.apache.spark.rdd.RDD<U> {
    // not preceding
  ...
  static public  class SplitInfoReflections {
    public   SplitInfoReflections () { throw new RuntimeException(); }
    public  Object inputSplitWithLocationInfo () { throw new RuntimeException(); }
    public  java.lang.reflect.Method getLocationInfo () { throw new RuntimeException(); }
    public  Object newInputSplit () { throw new RuntimeException(); }
    public  java.lang.reflect.Method newGetLocationInfo () { throw new RuntimeException(); }
    public  Object splitLocationInfo () { throw new RuntimeException(); }
    public  java.lang.reflect.Method isInMemory () { throw new RuntimeException(); }
    public  java.lang.reflect.Method getLocation () { throw new RuntimeException(); }
  }
  /**
  ...
  static public  scala.Option<org.apache.spark.rdd.HadoopRDD.SplitInfoReflections> SPLIT_INFO_REFLECTIONS () { throw new RuntimeException(); }
  static public  scala.collection.Seq<java.lang.String> convertSplitLocationInfo (java.lang.Object[] infos) { throw new RuntimeException(); }
  // not preceding
  // TypeTree().setOriginal(TypeBoundsTree(TypeTree().setOriginal(Select(Select(Ident(_root_), scala), scala.Nothing)), TypeTree().setOriginal(Select(Select(Ident(_root_), scala), scala.Any))))
  // TypeTree().setOriginal(TypeBoundsTree(TypeTree().setOriginal(Select(Select(Ident(_root_), scala), scala.Nothing)), TypeTree().setOriginal(Select(Select(Ident(_root_), scala), scala.Any))))
