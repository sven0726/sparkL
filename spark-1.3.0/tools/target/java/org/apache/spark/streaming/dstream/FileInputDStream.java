...
public  class FileInputDStream<K extends java.lang.Object, V extends java.lang.Object, F extends org.apache.hadoop.mapreduce.InputFormat<K, V>> extends org.apache.spark.streaming.dstream.InputDStream<scala.Tuple2<K, V>> {
  ...
  public   FileInputDStream (org.apache.spark.streaming.StreamingContext ssc_, java.lang.String directory, scala.Function1<org.apache.hadoop.fs.Path, java.lang.Object> filter, boolean newFilesOnly, scala.Option<org.apache.hadoop.conf.Configuration> conf, scala.reflect.ClassTag<K> km, scala.reflect.ClassTag<V> vm, scala.reflect.ClassTag<F> fm) { throw new RuntimeException(); }
  private  scala.Option<org.apache.spark.SerializableWritable<org.apache.hadoop.conf.Configuration>> serializableConfOpt () { throw new RuntimeException(); }
