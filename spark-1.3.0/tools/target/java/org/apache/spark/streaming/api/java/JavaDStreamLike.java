...
public  interface JavaDStreamLike<T extends java.lang.Object, This extends org.apache.spark.streaming.api.java.JavaDStreamLike<T, This, R>, R extends org.apache.spark.api.java.JavaRDDLike<T, R>> extends scala.Serializable {
   ...
   */
  public  org.apache.spark.streaming.dstream.DStream<T> reduceByWindow (scala.Function2<T, T, T> reduceFunc, org.apache.spark.streaming.Duration windowDuration, org.apache.spark.streaming.Duration slideDuration) ;
  /**
   * Return a new DStream in which each RDD has a single element generated by reducing all
   * elements in a sliding window over this DStream.
   * @param reduceFunc associative reduce function
   ...
   */
  public  void foreach (org.apache.spark.api.java.function.Function<R, java.lang.Void> foreachFunc) ;
  /**
   * Apply a function to each RDD in this DStream. This is an output operator, so
   * 'this' DStream will be registered as an output stream and therefore materialized.
   * <p>
   * @deprecated  As of release 0.9.0, replaced by foreachRDD
   */
  public  void foreach (org.apache.spark.api.java.function.Function2<R, org.apache.spark.streaming.Time, java.lang.Void> foreachFunc) ;
  /**
   * Apply a function to each RDD in this DStream. This is an output operator, so
   * 'this' DStream will be registered as an output stream and therefore materialized.
   */
  public  void foreachRDD (org.apache.spark.api.java.function.Function<R, java.lang.Void> foreachFunc) ;
  /**
   * Apply a function to each RDD in this DStream. This is an output operator, so
   * 'this' DStream will be registered as an output stream and therefore materialized.
   */
  public  void foreachRDD (org.apache.spark.api.java.function.Function2<R, org.apache.spark.streaming.Time, java.lang.Void> foreachFunc) ;
  /**
