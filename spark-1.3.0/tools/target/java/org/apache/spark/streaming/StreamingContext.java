...
public  class StreamingContext implements org.apache.spark.Logging {
   ...
   * @tparam F Input format for reading HDFS file
   */
  public <K extends java.lang.Object, V extends java.lang.Object, F extends org.apache.hadoop.mapreduce.InputFormat<K, V>> org.apache.spark.streaming.dstream.InputDStream<scala.Tuple2<K, V>> fileStream (java.lang.String directory, scala.Function1<org.apache.hadoop.fs.Path, java.lang.Object> filter, boolean newFilesOnly, org.apache.hadoop.conf.Configuration conf, scala.reflect.ClassTag<K> evidence$12, scala.reflect.ClassTag<V> evidence$13, scala.reflect.ClassTag<F> evidence$14) { throw new RuntimeException(); }
  /**
   * Create a input stream that monitors a Hadoop-compatible filesystem
   ...
   */
  public <T extends java.lang.Object> org.apache.spark.streaming.dstream.InputDStream<T> queueStream (scala.collection.mutable.Queue<org.apache.spark.rdd.RDD<T>> queue, boolean oneAtATime, scala.reflect.ClassTag<T> evidence$15) { throw new RuntimeException(); }
  /**
   * Create an input stream from a queue of RDDs. In each batch,
   * it will process either one or all of the RDDs returned by the queue.
   * @param queue      Queue of RDDs
   ...
   * @tparam T         Type of objects in the RDD
   */
  public <T extends java.lang.Object> org.apache.spark.streaming.dstream.InputDStream<T> queueStream (scala.collection.mutable.Queue<org.apache.spark.rdd.RDD<T>> queue, boolean oneAtATime, org.apache.spark.rdd.RDD<T> defaultRDD, scala.reflect.ClassTag<T> evidence$16) { throw new RuntimeException(); }
  /**
   * Create a unified DStream from multiple DStreams of the same type and same slide duration.
   */
  public <T extends java.lang.Object> org.apache.spark.streaming.dstream.DStream<T> union (scala.collection.Seq<org.apache.spark.streaming.dstream.DStream<T>> streams, scala.reflect.ClassTag<T> evidence$17) { throw new RuntimeException(); }
  /**
   * Create a new DStream in which each RDD is generated by applying a function on RDDs of
   * the DStreams.
   */
  public <T extends java.lang.Object> org.apache.spark.streaming.dstream.DStream<T> transform (scala.collection.Seq<org.apache.spark.streaming.dstream.DStream<?>> dstreams, scala.Function2<scala.collection.Seq<org.apache.spark.rdd.RDD<?>>, org.apache.spark.streaming.Time, org.apache.spark.rdd.RDD<T>> transformFunc, scala.reflect.ClassTag<T> evidence$18) { throw new RuntimeException(); }
