...
public  class ZeroMQUtils$ {
  ...
  public   ZeroMQUtils$ () { throw new RuntimeException(); }
  /**
   ...
   */
  public <T extends java.lang.Object> org.apache.spark.streaming.dstream.ReceiverInputDStream<T> createStream (org.apache.spark.streaming.StreamingContext ssc, java.lang.String publisherUrl, akka.zeromq.Subscribe subscribe, scala.Function1<scala.collection.Seq<akka.util.ByteString>, scala.collection.Iterator<T>> bytesToObjects, org.apache.spark.storage.StorageLevel storageLevel, akka.actor.SupervisorStrategy supervisorStrategy, scala.reflect.ClassTag<T> evidence$1) { throw new RuntimeException(); }
  /**
   * Create an input stream that receives messages pushed by a zeromq publisher.
