...
public  class ExecutorRunner implements org.apache.spark.Logging {
  ...
  // not preceding
  public   ExecutorRunner (java.lang.String appId, int execId, org.apache.spark.deploy.ApplicationDescription appDesc, int cores, int memory, akka.actor.ActorRef worker, java.lang.String workerId, java.lang.String host, int webUiPort, java.lang.String publicAddress, java.io.File sparkHome, java.io.File executorDir, java.lang.String workerUrl, org.apache.spark.SparkConf conf, scala.collection.Seq<java.lang.String> appLocalDirs, scala.Enumeration.Value state) { throw new RuntimeException(); }
