...
public  class ExecutorDesc {
  ...
  // not preceding
  public   ExecutorDesc (int id, org.apache.spark.deploy.master.ApplicationInfo application, org.apache.spark.deploy.master.WorkerInfo worker, int cores, int memory) { throw new RuntimeException(); }
