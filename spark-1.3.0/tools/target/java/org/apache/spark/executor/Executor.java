 ...
 */
public  class Executor implements org.apache.spark.Logging {
  ...
  private  akka.actor.ActorRef executorActor () { throw new RuntimeException(); }
  ...
  private  long gcTime () { throw new RuntimeException(); }
  /**
