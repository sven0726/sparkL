...
public  class CoarseGrainedExecutorBackend implements akka.actor.Actor, org.apache.spark.util.ActorLogReceive, org.apache.spark.executor.ExecutorBackend, org.apache.spark.Logging {
  ...
  public   CoarseGrainedExecutorBackend (java.lang.String driverUrl, java.lang.String executorId, java.lang.String hostPort, int cores, scala.collection.Seq<java.net.URL> userClassPath, org.apache.spark.SparkEnv env) { throw new RuntimeException(); }
